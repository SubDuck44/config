...
hl.env("_JAVA_AWT_WM_NON_REPARENTING", "1")
...
hl.workspace_rule({ workspace = "1", monitor = "DP-6", default = true })
hl.workspace_rule({ workspace = "101", monitor = "DP-5", default = true })
...
-- Flameshot
hl.bind("Print", hl.dsp.exec_raw("flameshot gui -r | wl-copy"))

-- OBS mute toggle
hl.bind(
	mainMod .. " + code:47",
	hl.dsp.send_shortcut({ mods = "ctrl", key = "code:47", window = "class:^(com\\.obsproject\\.Studio)$" })
)
